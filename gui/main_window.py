...
from gui.project_tab_workflows_mixin import ProjectTabWorkflowMixin
from gui.mod_search_panel_mixin import ModSearchMixin
from gui.mod_workflow_mixin import ModWorkflowMixin

class ProjectTab(ModWorkflowMixin, ModSearchMixin, ProjectTabWorkflowMixin):
