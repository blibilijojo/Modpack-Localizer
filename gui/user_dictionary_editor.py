...
class UserDictionaryEditor(ttk.Toplevel):
    ...
    def _create_widgets(self):
        ...
        self.key_origin_text = scrolledtext.ScrolledText(editor_frame, height=5, wrap="word")
        ...
        self.trans_text = scrolledtext.ScrolledText(editor_frame, height=5, wrap="word")
