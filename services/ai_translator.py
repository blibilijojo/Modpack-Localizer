...
class AITranslator:
    ...
    def _build_request_params(self, model_name, api_key, texts_to_translate, prompt_template):
        ...
        return client, {"model": effective_model_name, "messages": [{"role": "user", "content": prompt_content}]}, prompt_content
    ...
    def _check_cancelled(self, batch_inner: list) -> bool:
    ...
    def translate_batch(self, batch_info: tuple) -> list[str]:
        ...
        while attempt < max_attempts:
            ...
            try:
                client, request_params, prompt_content = self._build_request_params(model_name, api_key, texts_to_translate, prompt_template)
                ...
                try:
                    ...
                    if attempt >= max_attempts:
                        return self._fill_untranslated_with_source(cached_results, source_texts)
                    continue
    ...
    def _fill_untranslated_with_source(self, cached_results: list, source_texts: list[str]) -> list[str | None]:
